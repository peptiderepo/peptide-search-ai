...
- `includes/class-psa-ai-generator.php`: removed dead backward-compat proxy methods (all delegated to `PSA_AI_Content`; zero external callers). File reduced from 309 → 292 lines.
...
### Changed
- Plugin header: author updated to `peptiderepo`, Plugin URI corrected to GitHub repo URL.
